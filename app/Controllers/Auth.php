...
if ($user && password_verify($this->request->getPost('password'), $user['password'])) {
    // Determine primary id key safely (some schemas use `id`, others `user_id`)
    $primaryKey = (new \App\Models\UserModel())->primaryKey ?? 'user_id';
    $uid = $user[$primaryKey] ?? ($user['id'] ?? ($user['user_id'] ?? null));
